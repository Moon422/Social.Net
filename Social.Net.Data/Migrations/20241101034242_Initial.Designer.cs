...
namespace Social.Net.Data.Migrations
{
    ...
    [Migration("20241101034242_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Social.Net.Core.Domains.Directory.Address", b =>
                {
                    b.HasOne("Social.Net.Core.Domains.Directory.StateProvince", "StateProvince")
                        .WithMany()
            ...
            modelBuilder.Entity("Social.Net.Core.Domains.Directory.StateProvince", b =>
                {
                    b.HasOne("Social.Net.Core.Domains.Directory.Country", "Country")
            ...
            modelBuilder.Entity("Social.Net.Core.Domains.FriendManagement.FriendRequest", b =>
                {
                    b.HasOne("Social.Net.Core.Domains.Users.Profile", "ReceiverProfile")
                        .WithMany()
                        .HasForeignKey("ReceiverProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Social.Net.Core.Domains.Users.Profile", "SenderProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("Social.Net.Core.Domains.FriendManagement.Friendship", b =>
                {
                    b.HasOne("Social.Net.Core.Domains.Users.Profile", "Profile1")
                        .WithMany()
                        .HasForeignKey("ProfileId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Social.Net.Core.Domains.Users.Profile", "Profile2")
                        .WithMany()
            ...
            modelBuilder.Entity("Social.Net.Core.Domains.Users.Password", b =>
                {
                    b.HasOne("Social.Net.Core.Domains.Users.Profile", "Profile")
                        .WithOne("Password")
            ...
            modelBuilder.Entity("Social.Net.Core.Domains.Users.Profile", b =>
                {
                    b.HasOne("Social.Net.Core.Domains.Directory.Address", "PermanentAddress")
                        .WithMany()
                        .HasForeignKey("PermanentAddressId");

                    b.HasOne("Social.Net.Core.Domains.Directory.Address", "PresentAddress")
                        .WithMany()
